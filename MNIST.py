...
train_step = tf.train.AdamOptimizer(tf.train.exponential_decay(learning_rate=0.001, global_step=global_step, decay_steps=10, decay_rate=0.9, staircase=False)).minimize(cross_entropy)
